...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.28197219089602, 76.9520164067465453); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.27679281312177, 76.94053242591636); // Маркер Каспи Банка
    static final LatLng marker2 = new LatLng(52.28486169830497, 76.95188842449065); // Маркер remix
    static final LatLng marker3 = new LatLng(52.281002570097044, 76.95962373884392); // Маркер квазар
    static final LatLng marker4 = new LatLng(52.28155172080535, 76.94947180115994); // Маркер больница
    static final LatLng marker5 = new LatLng(52.28425514173115, 76.95302393729256); // Маркер дом дружбы
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.kspi)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.rmx)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.kvzr)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.pr)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.dd)).alpha(ALPHA).
